...
*----
     ...
     > UCONDF*12,UCONDC*12,SNAME*16,SCOMP*16
...
*----
     ...
     >  POROS,FNFU(ICH),NFD,NDTOT,IFLUID,SNAME,SCOMP,FCOOL,FFUEL,ACOOL,
     >  HD,PCH,
     ...
     >  TSURF(1,IX,IY),HCOOL(1,IX,IY),PCOOL(1,IX,IY),IPRES)
  260 CONTINUE
  265 CONTINUE
...
*----
  ...
  455   CONTINUE
     ...
     1  (PNAME.EQ.'T-FUEL')).AND.(KLONG.GT.0)) THEN
...
*     8 7H IPRES,I9,32H   (PRESSURE DROP (0=CONSTANT/1=NON CONSTANT)))
  550 FORMAT(
