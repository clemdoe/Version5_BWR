...
raw_data_0 = """
PCOOL:   10800000.0       10800000.0       10800000.0       10800000.0       10800000.0       10800000.0       10800000.0       10800000.0       10800000.0       10800000.0    
 ...
 MUT:  -1.96007129E-27   9.18340949E-41  -1.96007129E-27   9.18340949E-41   0.00000000       0.00000000       0.00000000       0.00000000       0.00000000       0.00000000    
 """



# Traitement de chaque ligne pour extraire les valeurs numériques
def extraire(var_name, line_nb, data):
...
fig, ax = plt.subplots()
ax.plot(zaxis, PCOOL, 'b-', label='PHIL0')
ax.plot(zaxis, PCOOL1, 'r-', label = 'PHI=1')
ax.plot(zaxis, PCOOL0, 'g-', label = 'PDROP=0')
ax.legend(loc = 'best')
plt.title('Effect of Martinellis Coefficient in the pressure drop model')
plt.show()
