...
*----
      ...
      REAL, ALLOCATABLE, DIMENSION(:) :: VGJprime,DCOOL
...
*----
      ...
      ALLOCATE(PTEMP(NZ), VTEMP(NZ),DCOOL(NZ))
      ALLOCATE(A(NZ,NZ+1))
...
*----
      DEALLOCATE(TCENT,TEMPT,VCOOL,DCOOL)
      DEALLOCATE(PTEMP, VTEMP,DLCOOL,DGCOOL,VGJprime,HLV)
      DEALLOCATE(A)
