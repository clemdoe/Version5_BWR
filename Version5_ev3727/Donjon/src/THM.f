...
*----
     ...
     >  POW(1,IX,IY),IPRES,TCOMB(1,IX,IY),DCOOL(1,IX,IY),TCOOL(1,IX,IY),
     >  TSURF(1,IX,IY),HCOOL(1,IX,IY),PCOOL(1,IX,IY))
  260 CONTINUE
  265 CONTINUE
      IF(IMPX.GT.1) WRITE(6,610) SUMSEC,CWSECT
      PRINT *, 'THM ligne 982 CWSECT=',CWSECT
      DEALLOCATE(RVAL)
...
*
  ...
  540 FORMAT(/
     ...
     8 7H IGAP  ,I9,38H   (GAP IS CONSIDERED (0=GAP/1=NO GAP)/
