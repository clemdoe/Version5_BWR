...
*----
        DTINV=0.0
        PRINT *, 'THMDRV: STARTING CONDUCTION SOLUTION FOR CHANNEL'
        PRINT *, 'IX=', IX, ' IY=', IY, ' K=', K
        PRINT *, 'IMPX=', IMPX, ' NFD=', NFD, ' NDTOT-1=', NDTOT-1
        PRINT *, 'MAXIT1=', MAXIT1, ' MAXITL=', MAXITL
        PRINT *, ' ERMAXT=', ERMAXT
        PRINT *, 'DTINV=', DTINV, ' RADD=', RADD
        PRINT *, 'TRE11=', TRE11
        PRINT *, 'QFUEL(K)=', QFUEL(K), ' FRO=', FRO
        PRINT *, 'FRO=', FRO
        PRINT *, 'TRE11(NDTOT)=', TRE11(NDTOT)
        PRINT *,' XBURN(K)=', XBURN(K)
        PRINT *, 'POROS=', POROS, ' FRACPU=', FRACPU
        PRINT *, 'ICONDF=', ICONDF, ' NCONDF=', NCONDF
        PRINT *, 'KCONDF=', KCONDF
        PRINT *, 'UCONDF=', UCONDF, ' ICONDC=', ICONDC
        PRINT *, 'NCONDC=', NCONDC, ' KCONDC=', KCONDC
        PRINT *, 'UCONDC=', UCONDC, ' IHGAP=', IHGAP
        PRINT *, 'KHGAP=', KHGAP, ' IFRCDI=', IFRCDI
        PRINT *, 'TC1=', TC1, ' XX2=', XX2
        PRINT *, 'XX3=', XX3, ' ZF=', ZF
